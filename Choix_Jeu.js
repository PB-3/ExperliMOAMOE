...
function choix_scenario(event) {
  ...
  if (selectedChoice === 'MOA') {
    window.location.href='MOA/Jeu_MOA.html';
    ...
    window.location.href='MOE-code/Jeu_MOE.html';
  ...
  // Afficher le chemin d'accès au dossier parent (last)
    console.log(grandParentUrl);  
    window.location.href='prince2_pmbok/Jeu_PRINCE2_PMBOK.html';
  }
    ...
    // Afficher le chemin d'accès au dossier parent (last)
    console.log(grandParentUrl);
    window.location.href='norme_qualite/norme_qualite.html';
