...
function choix_scenario(event) {
  ...
  if (selectedChoice === 'MOA') {
    ...
    window.location.href=grandParentUrl+'/MOE-code/x.html';
  ...
  // Afficher le chemin d'accès au dossier parent (last)
    console.log(grandParentUrl);  
    window.location.href=grandParentUrl+'/prince2_pmbok/game.html';
  }
    ...
    window.location.href=grandParentUrl+'/norme_qualite/x.html';
